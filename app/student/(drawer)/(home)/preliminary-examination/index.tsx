...
const PreliminaryExam = () => {
	...
	const {
		...
		setValue,
	} = useForm<PreliminaryExamination>({ mode: "onChange" });
			...
			if (recordId) {
				try {
					const response = await axios.get(
						`${SERVER}/record/${recordId}`
					);

					if (response.data) {
						const preliminaryExamination:
							| PreliminaryExamination
							| any = response.data.preliminaryExamination;

						if (preliminaryExamination) {
							// Set multiple values at once
							Object.keys(preliminaryExamination).forEach(
								(key) => {
									setValue(
										key as keyof PreliminaryExamination,
										preliminaryExamination[key]
									);
								}
							);
							setCornealImgUrl(
							...
							setOcularMotilitySketchOD(
								preliminaryExamination.ocularMotility.od
							);
							setOcularMotilitySketchOS(
	...
	const submitForm = async () => {
		if (isValid) {
			...
			Alert.alert("Missing fields", "Corneal Reflex");
			setIsLoading(false);
		} else if (!ocularMotilitySketchOD || !ocularMotilitySketchOS) {
			Alert.alert("Missing fields", "Ocular Motility");
			setIsLoading(false);
		} else {
	...
	const uploadImage = async (uri: string | "", fileType: string) => {
		try {
			...
			const storageRef = ref(
				storage,
				`ocular-motility-images/${user?.id}/patient-${
					patient?._id
				}/${new Date().getTime()}`
			);
		...
		>
			...
			{patient.records[0]?.preliminaryExamination?.isComplete && (
				<XStack
					...
					paddingHorizontal="$3"
				>
					<SizableText color={"$green3"}>
						<CheckCircle color={"$green5"} size={10} /> Completed
					</SizableText>
					<SizableText size={"$1"} color={"$green3"}>
						{moment(
							patient.records[0]?.preliminaryExamination
								?.createdAt
			...
			>
				<View padded>
					...
					<XStack alignItems="center" gap="$3">
						<View flex={1}>
							<TextInput
								control={control}
								name="pupillaryDistance.monocular.OD"
								label="OD:"
						...
						<View flex={1}>
							<TextInput
								...
								control={control}
								name="pupillaryDistance.monocular.OS"
								label="OS:"
					...
					<XStack alignItems="center" gap="$3">
						<View flex={1}>
							<TextInput
								...
								control={control}
								label="Near"
								name="pupillaryDistance.binocular.near"
						...
						<View flex={1}>
							<TextInput
								...
								control={control}
								label="Far"
								name="pupillaryDistance.binocular.far"
				...
				<View padded>
					...
					<SelectTextInput
						...
						options={[
							{
								label: "Crossed Dominance",
								value: "crossed dominance",
							},
							{
								label: "Uncrossed Dominance",
								value: "uncrossed Dominance",
							},
						]}
						required
					/>
				...
				<View padded>
					...
					<Image
						...
						src={
							cornealImgUrl
								? cornealImgUrl
								: cornealImgPlaceholder
						}
						width={"100%"}
						height={120}
						objectFit={cornealImgUrl ? "cover" : "contain"}
						mt="$4"
					/>
					<SizableText
						size={"$1"}
						color={"$gray10"}
						textAlign="center"
						display={cornealImgUrl ? "none" : "block"}
					>
						No photo added yet.
					</SizableText>
				...
				<View padded>
					...
					<TextInput
						...
						control={control}
						name="pupillaryFunction.indirect"
						placeholder="Enter indirect"
						label="Indirect"
						required
					/>
					<TextArea
						control={control}
						name="pupillaryFunction.Notes:"
						placeholder="Enter notes here"
						label="Notes:"
					/>
					<XStack
				...
				<View padded>
					...
					<YStack flex={1}>
						...
						<SelectTextInput
							control={control}
							name="coverTest.unilateral.far.od"
							label="OD:"
							placeholder="Select"
						...
						<SelectTextInput
							control={control}
							name="coverTest.unilateral.far.os"
							label="OS:"
							placeholder="Select"
							options={coverTestOptions}
							required
					...
					<YStack flex={1}>
						...
						<SelectTextInput
							control={control}
							name="coverTest.unilateral.near.od"
							label="OD:"
							placeholder="Select"
							options={coverTestOptions}
							required
						...
						<SelectTextInput
							control={control}
							name="coverTest.unilateral.near.os"
							label="OS:"
							placeholder="Select"
							options={coverTestOptions}
							required
					...
					<YStack flex={1}>
						...
						<SelectTextInput
							control={control}
							name="coverTest.alternate.far.od"
							label="OD:"
							placeholder="Select"
							options={coverTestOptions}
							required
						...
						<SelectTextInput
							control={control}
							name="coverTest.alternate.far.os"
							label="OS:"
							placeholder="Select"
							options={coverTestOptions}
							required
					...
					<YStack flex={1}>
						...
						<SelectTextInput
							control={control}
							name="coverTest.alternate.near.od"
							label="OD:"
							placeholder="Select"
							options={coverTestOptions}
							required
						...
						<SelectTextInput
							control={control}
							name="coverTest.alternate.near.os"
							label="OS:"
							placeholder="Select"
							options={coverTestOptions}
							required
				...
				<View padded>
					...
					<TextInput
						control={control}
						name="motilityTest.version.broadH"
						label="Broad H"
						placeholder="Enter broad h"
						required
						onSubmitEditing={() => focus(5)}
					/>
					<TextInput
						ref={inputRefs.current[5]}
						control={control}
						name="motilityTest.version.saccades"
						label="Saccades"
						placeholder="Enter saccades"
						required
						onSubmitEditing={() => focus(6)}
					/>
					<TextInput
						ref={inputRefs.current[6]}
						control={control}
						name="motilityTest.version.pursuit"
						label="Pursuit"
						placeholder="Enter pursuit"
						required
					/>
					<SizableText
						backgroundColor={"$gray3"}
					...
					<SelectTextInput
						control={control}
						name="motilityTest.duction.od"
						placeholder="Select"
						label="OD"
						options={motilityTestOptions}
						required
					/>
					<SelectTextInput
						control={control}
						name="motilityTest.duction.os"
						placeholder="Select"
						label="OS"
						options={motilityTestOptions}
						required
					...
					<TextInput
						control={control}
						name="stereoptyTest.stereopsis"
						label="Stereopsis"
						placeholder="Enter stereopsis"
						required
					/>
					<SizableText
						backgroundColor={"$gray3"}
					...
					<TextInput
						control={control}
						name="colorVision.ishihara.od"
						label="Ishihara OD"
						placeholder="Enter ishihara OD"
						required
					...
					<TextInput
						...
						control={control}
						name="colorVision.ishihara.os"
						label="Ishihara OS"
						placeholder="Enter ishihara OS"
						required
					/>
					<TextArea
						control={control}
						name="motilityTest.note"
						label="Notes:"
						placeholder="Enter notes here"
					/>
				</View>
				<View padded>
					...
					<SizableText
						...
						alignItems="center"
					>
						Click on each image to edit{" "}
						<Pen size={12} color={"$gray10"} />
					</SizableText>
					<TextArea
						control={control}
						placeholder="Enter notes here"
						label="Notes:"
						name="ocularMotility.note"
					/>
				</View>
				<View padded>
					...
					<TextInput
						control={control}
						name="nearPointAccomodation.od.trial1"
						label="1st Trial"
						placeholder="Enter first trial"
						required
						onSubmitEditing={() => focus(8)}
					/>
					<TextInput
						ref={inputRefs.current[8]}
						control={control}
						name="nearPointAccomodation.od.trial2"
						label="2nd Trial"
						placeholder="Enter second trial"
						required
						onSubmitEditing={() => focus(9)}
					/>
					<TextInput
						ref={inputRefs.current[9]}
						control={control}
						name="nearPointAccomodation.od.trial3"
						label="3rd Trial"
						placeholder="Enter third trial"
						required
						onSubmitEditing={() => focus(10)}
					/>
					<SizableText
						backgroundColor={"$gray3"}
						padding="$1"
					...
					<TextInput
						...
						control={control}
						name="nearPointAccomodation.os.trial1"
						label="1st Trial"
						placeholder="Enter first trial"
						required
						onSubmitEditing={() => focus(11)}
					/>
					<TextInput
						ref={inputRefs.current[11]}
						control={control}
						name="nearPointAccomodation.os.trial2"
						label="2nd Trial"
						placeholder="Enter second trial"
						required
						onSubmitEditing={() => focus(12)}
					/>
					<TextInput
						ref={inputRefs.current[12]}
						control={control}
						name="nearPointAccomodation.os.trial3"
						label="3rd Trial"
						placeholder="Enter third trial"
						required
						onSubmitEditing={() => focus(13)}
					/>
					<SizableText
						backgroundColor={"$gray3"}
						padding="$1"
					...
					<TextInput
						...
						control={control}
						name="nearPointAccomodation.ou.trial1"
						label="1st Trial"
						placeholder="Enter first trial"
						required
						onSubmitEditing={() => focus(14)}
					/>
					<TextInput
						ref={inputRefs.current[14]}
						control={control}
						name="nearPointAccomodation.ou.trial2"
						label="2nd Trial"
						placeholder="Enter second trial"
						required
						onSubmitEditing={() => focus(15)}
					/>
					<TextInput
						ref={inputRefs.current[15]}
						control={control}
						name="nearPointAccomodation.ou.trial3"
						label="3rd Trial"
						placeholder="Enter third trial"
						required
					/>
				...
				<View padded>
					...
					<TextInput
						...
						control={control}
						name="nearPointConvergence.ou.trial1"
						label="1st Trial"
						placeholder="Enter first trial"
						required
						onSubmitEditing={() => focus(17)}
					/>
					<TextInput
						ref={inputRefs.current[17]}
						control={control}
						name="nearPointConvergence.ou.trial2"
						label="2nd Trial"
						placeholder="Enter second trial"
						required
						onSubmitEditing={() => focus(18)}
					/>
					<TextInput
						ref={inputRefs.current[18]}
						control={control}
						name="nearPointConvergence.ou.trial3"
						label="3rd Trial"
						placeholder="Enter third trial"
						required
					/>
